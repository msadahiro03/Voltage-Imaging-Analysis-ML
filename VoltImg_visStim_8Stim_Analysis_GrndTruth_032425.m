...
% This analysis is used for in vivo voltage imaging for visual evoked or
% spontaneous activity where the readout includes ephys groundtruth (whole or loose).
%%
clear all
close all
