...
for tt = 1:nTrials %size(vsTest_inputs, 2)
    ...
    baselinePreImageStack = imageStack(roiX, roiY, 1:startTimeImaging); % image stack in ROI before start of stimulation
...
voltMapping.mouseID = ['voltMapping_Analysis_', expID, '_Day6', '_newBaselining', '_cell1'];
